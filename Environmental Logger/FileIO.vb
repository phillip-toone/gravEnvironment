...
Module FileIO
   ...
   Public Function WriteTextFile(ByVal filepath As String, ByRef text As String, Optional ByVal overWrite As Boolean = True, Optional ByVal Append As Boolean = False) As Boolean
      Try
         If overWrite = False Then
            Dim DI As New DirectoryInfo(filepath.Substring(0, filepath.LastIndexOf("\")))
   ...
   ''' <remarks></remarks>
   Function GetFileName(ByVal mustExist As Boolean, Optional ByVal extension As String = ".txt", Optional ByVal title As String = "") As String
      Dim Path As String = ""
      ...
      If mustExist Then
         ...
         If extension = ".csv" Then
            OD.Filter = "Excel format (*.csv)|*.csv"
         Else
            OD.Filter = "Text file (*" & extension & ")|*" & extension
         End If
         'OD.Filter = "Text files (*.txt)|*.txt"
         OD.ValidateNames = True
         OD.ShowDialog()
      ...
      Else
         ...
         End If
         If extension = ".csv" Then
            SD.Filter = "Excel format (*.csv)|*.csv"
         Else
